  ...
  return (
    <div className="h-full">
      <Link href={post.permalink} target="_blank" rel="noopener noreferrer">
        <div className="relative aspect-square rounded-lg overflow-hidden shadow-md group hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-pink-100 to-purple-100">
          <Image
            src={post.media_url}
